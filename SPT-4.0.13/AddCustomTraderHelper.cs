        ...
        DatabaseService databaseService)
    {
        ...
        public void AddTraderWithEmptyAssortToDb(TraderBase traderDetailsToAdd)
        {
            ...
            var traderDataToAdd = new Trader
            {
                ...
                ?? throw new InvalidOperationException("Failed to clone trader base data"),
            ...
            if (!databaseService.GetTraders().TryAdd(traderDetailsToAdd.Id, traderDataToAdd))
            {
        ...
        public void AddTraderToLocales(TraderBase baseJson, string firstName, string description)
        {
            ...
            var nickName = baseJson.Nickname ?? string.Empty;
        ...
        {
            if (!databaseService.GetTraders().TryGetValue(traderId, out var traderToEdit))
            {
