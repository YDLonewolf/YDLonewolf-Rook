    ...
    : IOnLoad
{
    public Task OnLoadAsync(CancellationToken cancellationToken)
    {
        ...
        var traderImagePath = Path.Combine(pathToMod, "data/avatar.jpg");
    ...
    ?? throw new InvalidOperationException("Trader avatar path is missing");

        imageRouter.AddRoute(avatar.Replace(".jpg", ""), traderImagePath);
